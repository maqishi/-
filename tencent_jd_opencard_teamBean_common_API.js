...
!(async () => {
    ...
    if (!process.env.TT_tencent_function_name_common) {
        console.log("没有配置环境变量 [TT_tencent_function_name_common]");
        return
    } else {
        tencent_function_name = process.env.TT_tencent_function_name_common
    }
    ...
    const params = {
        ...
        "ClientContext": JSON.stringify({
            "RUN_SCRIPT": "jd_opencard_teamBean_commom_enc",
