...
Download_SSR(){
	cd "/usr/local/"
	wget -N --no-check-certificate "https://ghproxy.com/https://github.com/ToyoDAdoubiBackup/shadowsocksr/archive/manyuser.zip"
	#git config --global http.sslVerify false
	#env GIT_SSL_NO_VERIFY=true git clone -b manyuser https://ghproxy.com/https://github.com/ToyoDAdoubiBackup/shadowsocksr.git
