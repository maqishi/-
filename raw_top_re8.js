...
入口
https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/832865?activityId=33d9ae00c1904c20bd8a4488fc5d6f33&shareUuid=504b046486d34892acb61922cc05e234

============Quantumultx===============
[task_local]
#8.10-8.22 头号玩家 一起热8
36 0,8 4-12 8 * http://nm66.top/re8.js, tag=8.10-8.22 头号玩家 一起热8, enabled=true

================Loon==============
[Script]
cron "36 0,8 4-12 8 *" script-path=re8.js,tag=8.10-8.22 头号玩家 一起热8

===============Surge=================
8.10-8.22 头号玩家 一起热8 = type=cron,cronexp="36 0,8 4-12 8 *",wake-system=1,timeout=3600,script-path=re8.js

============小火箭=========
8.10-8.22 头号玩家 一起热8 = type=cron,script-path=re8.js, cronexpr="36 0,8 4-12 8 *", timeout=3600, enable=true
*/
...
!(async () => {
  ...
  $.shareUuid = '504b046486d34892acb61922cc05e234'
...
function followShop() {
  return new Promise(resolve => {
    let body = `activityId=33d9ae00c1904c20bd8a4488fc5d6f33&pin=${encodeURIComponent($.myPingData.secretPin)}&actorUuid=${$.actorUuid}&taskType=23&taskValue=1000009621&shareUuid=${$.shareUuid}`
...
function adLog() {
  return new Promise(resolve => {
    ...
    $.post({
      ...
      body: `venderId=1000009621&code=99&pin=${encodeURIComponent($.myPingData.secretPin)}&activityId=33d9ae00c1904c20bd8a4488fc5d6f33&pageUrl=${encodeURIComponent(pageurl)}&subType=APP&adSource=null`,
      headers: {
        'User-Agent': $.UA,
        'Host':'lzdz1-isv.isvjcloud.com',
