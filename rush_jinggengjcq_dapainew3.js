...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://gitee.com/fate/light/dongge/raw/master/dongge/jinggengjcq_dapainew.json')
    if(authorCodeList === '404: Not Found'){
        authorCodeList = [
            'oBfIqBye826Rum3TiLF3ul4tLNYA4seuA67MOIYQxEk3Vl9+AVo4NF+tgyeIc6A6kdK3rLBQpEQH9V4tdrrh0w==',
        ]
    }
